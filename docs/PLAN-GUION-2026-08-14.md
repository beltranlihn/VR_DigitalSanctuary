...
- ✅ **ACTO 6 — LOVING REWORKEADO (2026-08-15)**: mueren las 3 preguntas en TextRender; entran los **3 campos de luz**.
  ...
  - **La calma del EEG los modula a 10 Hz**: `efectivo = Intensity × (0,35 + 0,65 × Calm)`. El piso de 0,35 es deliberado — con el EEG desconectado el campo baja pero **no desaparece** (un módulo ausente nunca se ve como error).
