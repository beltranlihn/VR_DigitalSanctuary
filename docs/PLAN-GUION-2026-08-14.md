...
- 🔜 **PRÓXIMO PASO — el framework de audio + haptics (1.d)**, que es el paso 3 del orden de construcción: crossfade de ambients por sala, catálogo de SFX por nombre y los 3 patrones hápticos (hover / selección / hold). La ceremonia ya dejó el patrón de placeholder data-driven para copiar. ⚠ Pendiente aparte: **la carga final** (etapa 5 = 100 % + disolución animada del HUD), que hoy corre la ceremonia normal.
