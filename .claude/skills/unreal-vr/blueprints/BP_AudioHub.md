...
| Haptics | ⬜ **Nadie lo llama todavía.** El primer candidato es el pulso de Heart (Beltrán reportó en visor que *"tampoco sentí el pulso haptic"*): `PulseJump` de Recognizing debería llamar `HapticSelect`. |
