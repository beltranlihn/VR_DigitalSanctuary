...
| 🆕 **BP_SaveButton** | `Stages/Touch/` | Botón **"FINISH MELODY"**. **Siempre presente**, al centro de la fila de slots y 20 cm más abajo; al llenarse los 5 slots **crece** (se "activa") en vez de aparecer. Se confirma con **hold de 3 s** del gatillo apuntándolo. Dispara `OnConfirmed` (lo consume R6). | 🟡 falta visor | [✓](BP_SaveButton.md) |
