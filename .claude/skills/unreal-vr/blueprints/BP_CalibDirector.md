...
- **`BP_CalibInstrPanel`** (actor nuevo) — host del widget: un WidgetComponent `Panel` (`WidgetClass=WBP_CalibInstructions`, `Space=World`, `DrawSize 1000x600`, `RelativeScale3D 0.1`, `bIsTwoSided=true`). **Se SPAWNEA en runtime** en un TargetPoint, igual que los otros stages (2026-07-23, pedido del usuario — antes era un WidgetComponent en el Director, que quedaba horneado y visible en el editor; se removió).
